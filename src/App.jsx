...
function MatchCard({ fixture, selected, onToggle, compact = false, translations = {} }) {
  ...
  const homeName = translations[homeOriginal] || homeOriginal;
  const awayName = translations[awayOriginal] || awayOriginal;
  return (
    <button
      type="button"
